//Add new client form fields
export const clientInputFields =(selectedRowId, currentData) => [
    {
      id: 1,
      label: "Name *",
      type: "text",
    ...
    {
        id: 8,
        label: selectedRowId !== null && Object.keys(currentData).length !== 0 ? "Update Client":"Add Client",
        type: "button",
        tabIndex: 6,
        btntype: "submit",
        color: "primary",
